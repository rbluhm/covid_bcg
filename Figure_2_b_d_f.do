...
merge 1:1 nuts_id using ./data/cases_pop_cat_c_singleages_week17, force
ta _me
drop if _me==2
drop _me

*drop cases_age_*
ren age_*_cases_cat_c cases_age_*
...
global Tlcp_total "Log(1+severe cases/million)"
global Tlcp_`j0'_44 "Log(1+severe cases/million) `j0'-44 Year Olds"
global Tlcp_46_`j1' "Log(1+severe cases/million)  46-`j1' Year Olds"
...
graph export ./output/Figure_2_cat_c_`v'.pdf, replace
drop rdplot_*
}
}
