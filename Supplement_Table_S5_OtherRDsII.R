...
# rows
dvs <- c("ln_adj_total_rate", "ln_adj_infectious_rate", "ln_adj_respiratory_rate", 
         "ln_adj_hosp_rate", "ln_adj_infectious_hosp_rate", "ln_adj_respiratory_hosp_rate") 

stopifnot(dvs %in% names(bcg.df))

dv_labs <- c("Panel A. Age-adjusted overall death rate per million",
             "Panel B. Age-adjusted infectious diseases death rate per million",
             "Panel C. Age-adjusted respiratory diseases death rate per million",
             "Panel D. Age-adjusted overall hospitalization rate per million",
             "Panel E. Age-adjusted infectious diseases hospitalization rate per million",
             "Panel F. Age-adjusted respiratory diseases hospitalization rate per million")
...
# create tex output
sink("./output/Supplement_Table_S5_OtherRDsII.tex")
latextable(full.tbl)
sink()

#read and modify

fin.tex <- readLines("./output/Supplement_Table_S5_OtherRDsII.tex")
...
fileConn<-file("./output/Supplement_Table_S5_OtherRDsII.tex")
